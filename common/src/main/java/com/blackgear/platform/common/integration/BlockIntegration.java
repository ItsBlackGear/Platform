...
public class BlockIntegration {
    ...
    public interface Event {
        ...
        default void registerSlashableBlock(BlockState target, float destroySpeed) {
            SWORDABLES.putIfAbsent(target, destroySpeed);
        }

        default void registerSlashableBlock(Block target, float destroySpeed) {
            registerSlashableBlock(target.defaultBlockState(), destroySpeed);
        }
